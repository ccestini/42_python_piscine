...
def main():
    ...
    assert filtered_names_builtin == filtered_names_custom, "Test case 1 failed"
    ...
    assert filtered_numbers_builtin == filtered_numbers_custom, "Test case 2 failed"
    print("***Test case 2 passed***")


if __name__ == "__main__":
    print(f"\n***built-in docstring:***\n{filter.__doc__}\n***")
    print(f"\n***mine docstring:***{ft_filter.__doc__}***\n")
    main()
